create_clock -period 10.00 -name CLK_100MHZ -waveform {0.00 5.000} [get_ports CLK_100MHZ]
...
#create_generated_clock -name CLK_125MHZ -source [get_pins {Sys_Clk_PLL_inst|altpll_component|auto_generated|pll1|inclk[0]}] -multiply_by 5 -divide_by 4 [get_pins {Sys_Clk_PLL_inst|altpll_component|auto_generated|pll1|clk[0]}]
#create_generated_clock -name CLK_125MHZ_90 -source [get_pins {Sys_Clk_PLL_inst|altpll_component|auto_generated|pll1|inclk[0]}] -multiply_by 5 -divide_by 4 [get_pins {Sys_Clk_PLL_inst|altpll_component|auto_generated|pll1|clk[1]}]


create_generated_clock -name RGMII_TX_CLK_90 -source [get_pins {Sys_Clk_PLL_inst|altpll_component|auto_generated|pll1|clk[1]}] -multiply_by 1 [get_ports RGMII_TXC]
...
set_false_path -rise_from [get_clocks Sys_Clk_PLL_inst|altpll_component|auto_generated|pll1|clk[0]] -fall_to [get_clocks RGMII_TX_CLK_90] -setup
set_false_path -fall_from [get_clocks Sys_Clk_PLL_inst|altpll_component|auto_generated|pll1|clk[0]] -rise_to [get_clocks RGMII_TX_CLK_90] -setup
set_false_path -rise_from [get_clocks Sys_Clk_PLL_inst|altpll_component|auto_generated|pll1|clk[0]] -rise_to [get_clocks RGMII_TX_CLK_90] -hold
set_false_path -fall_from [get_clocks Sys_Clk_PLL_inst|altpll_component|auto_generated|pll1|clk[0]] -fall_to [get_clocks RGMII_TX_CLK_90] -hold


set_false_path -from [get_clocks CLK_100MHZ] -to [get_clocks RGMII_RXC]
set_false_path -from [get_clocks RGMII_RXC] -to [get_clocks CLK_100MHZ]