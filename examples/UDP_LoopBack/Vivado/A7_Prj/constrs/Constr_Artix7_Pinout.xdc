...
set_property PACKAGE_PIN E15 [get_ports CLK_100MHZ]

set_property PACKAGE_PIN D8 [get_ports {RGMII_TXD[0]}]
set_property PACKAGE_PIN C8 [get_ports {RGMII_TXD[1]}]
set_property PACKAGE_PIN D9 [get_ports {RGMII_TXD[2]}]
set_property PACKAGE_PIN C9 [get_ports {RGMII_TXD[3]}]
set_property PACKAGE_PIN B9 [get_ports RGMII_TXC_CTL]
set_property PACKAGE_PIN A9 [get_ports RGMII_TXC]
...
set_property PACKAGE_PIN C11 [get_ports {RGMII_RXD[0]}]
set_property PACKAGE_PIN B11 [get_ports {RGMII_RXD[1]}]
set_property PACKAGE_PIN B10 [get_ports {RGMII_RXD[2]}]
set_property PACKAGE_PIN A10 [get_ports {RGMII_RXD[3]}]
set_property PACKAGE_PIN D11 [get_ports RGMII_RX_CTL]
set_property PACKAGE_PIN E16 [get_ports RGMII_RXC]
