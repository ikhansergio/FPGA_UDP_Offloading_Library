...
# SDC constraint example for the KSZ9031 in default mode. No MDIO registers access after reset. All MDIO registers are in default state.  [[...]](./AXISx8_RGMII_BRIDGE/KSZ9031_Def_Constraint.md)
