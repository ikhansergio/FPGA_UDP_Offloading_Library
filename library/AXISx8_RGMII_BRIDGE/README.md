...
# SDC constraint example for the KSZ9031 in default mode. No MDIO registers access after reset. All MDIO registers are in default state.  [[...]](KSZ9031_Def_Constraint.md)
